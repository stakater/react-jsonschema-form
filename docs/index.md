...
```bash
$ npm install @stakater/fs-core --save
```
...
```html
  <script src="https://unpkg.com/@stakater/fs-core/dist/react-jsonschema-form.js"></script>
```

Source maps are available at [this url](https://unpkg.com/@stakater/fs-core/dist/react-jsonschema-form.js.map).
