...
<p align="center">
  ...
  <h3 align="center">@stakater/fs-antd</h3>
...
```sh
npm install antd @ant-design/icons dayjs @stakater/fs-core
```

### Installation

```sh
npm install @stakater/fs-antd
```

## Usage

```javascript
import Form from '@stakater/fs-antd';
```
...
import { Theme as AntDTheme } from '@stakater/fs-antd';
...
[npm-shield]: https://img.shields.io/npm/v/@stakater/fs-antd/latest.svg?style=flat-square
[npm-url]: https://www.npmjs.com/package/@stakater/fs-antd
[npm-dl-shield]: https://img.shields.io/npm/dm/@stakater/fs-antd.svg?style=flat-square
[npm-dl-url]: https://www.npmjs.com/package/@stakater/fs-antd
