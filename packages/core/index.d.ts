// Originally from https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/@stakater/fs-core/index.d.ts

declare module '@stakater/fs-core' {
...
declare module '@stakater/fs-core/lib/components/fields/SchemaField' {
    import { JSONSchema7 } from 'json-schema';
    import { FieldProps, UiSchema, IdSchema, FormValidation } from '@stakater/fs-core';
...
declare module '@stakater/fs-core/lib/validate' {
    import { JSONSchema7Definition } from 'json-schema';
    import { AjvError, ErrorSchema, FormProps } from '@stakater/fs-core';
