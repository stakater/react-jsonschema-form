...
<p align="center">
  ...
  <h3 align="center">@stakater/fs-material-ui</h3>
...
[![@stakater/fs-material-ui Screen Shot][product-screenshot]](https://rjsf-team.github.io/@stakater/fs-material-ui)
...
- `@material-ui/icons`
- `@stakater/fs-core >= 2.0.0`

```bash
yarn add @material-ui/core @material-ui/icons @stakater/fs-core
```

### Installation

```bash
yarn add @stakater/fs-material-ui
```
...
```js
import { withTheme } from '@stakater/fs-core';
import { Theme as MaterialUITheme } from '@stakater/fs-material-ui';
...
[npm-shield]: https://img.shields.io/npm/v/@stakater/fs-material-ui/latest.svg?style=flat-square
[npm-url]: https://www.npmjs.com/package/@stakater/fs-material-ui
[npm-dl-shield]: https://img.shields.io/npm/dm/@stakater/fs-material-ui.svg?style=flat-square
[npm-dl-url]: https://www.npmjs.com/package/@stakater/fs-material-ui
