...
<p align="center">
  ...
  <h3 align="center">@stakater/fs-fluent-ui</h3>
...
```bash
yarn add @fluentui/react @stakater/fs-core
```
...
```bash
yarn add @stakater/fs-fluent-ui
```
...
```js
import Form from '@stakater/fs-fluent-ui';
```
...
import { Theme as FluentUITheme } from '@stakater/fs-fluent-ui';
...
[npm-shield]: https://img.shields.io/npm/v/@stakater/fs-fluent-ui/latest.svg?style=flat-square
[npm-url]: https://www.npmjs.com/package/@stakater/fs-fluent-ui
[npm-dl-shield]: https://img.shields.io/npm/dm/@stakater/fs-fluent-ui.svg?style=flat-square
[npm-dl-url]: https://www.npmjs.com/package/@stakater/fs-fluent-ui
