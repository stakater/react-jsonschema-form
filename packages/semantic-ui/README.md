...
```sh
yarn add semantic-ui-css semantic-ui-react @stakater/fs-core
```

### Installation

```sh
yarn add @stakater/fs-semantic-ui
```
...
```javascript
import Form from '@stakater/fs-semantic-ui';
```
...
import { Theme as SemanticUITheme } from '@stakater/fs-semantic-ui';
...
[npm-shield]: https://img.shields.io/npm/v/@stakater/fs-semantic-ui/latest.svg?style=flat-square
[npm-url]: https://www.npmjs.com/package/@stakater/fs-semantic-ui
[npm-dl-shield]: https://img.shields.io/npm/dm/@stakater/fs-semantic-ui.svg?style=flat-square
[npm-dl-url]: https://www.npmjs.com/package/@stakater/fs-semantic-ui
